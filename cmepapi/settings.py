"""
Django settings for cmepapi project.
...
WSGI_APPLICATION = 'cmepapi.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'cmegpapi'),
...
STATICFILES_DIRS = ((BASE_DIR.joinpath('templates', 'static')),)
